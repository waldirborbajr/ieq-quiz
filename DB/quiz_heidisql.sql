...
) TYPE=InnoDB AUTO_INCREMENT=16 /*!40100 DEFAULT CHARSET=latin1*/;
...
) TYPE=InnoDB AUTO_INCREMENT=22 /*!40100 DEFAULT CHARSET=latin1*/;
...
LOCK TABLES `wquiz_person_answers` WRITE;
/*!40000 ALTER TABLE `wquiz_person_answers` DISABLE KEYS*/;
REPLACE INTO `wquiz_person_answers` (`id_person_answer`, `id_question`, `id_answer`, `laptime`, `id_quiz`, `id_person`) VALUES
	('34','2','8','00:00:02','1','5'),
	('35','3','14','00:00:01','1','5'),
	('36','1','1','00:00:01','1','5');
/*!40000 ALTER TABLE `wquiz_person_answers` ENABLE KEYS*/;
UNLOCK TABLES;
...
LOCK TABLES `wquiz_person_quiz` WRITE;
/*!40000 ALTER TABLE `wquiz_person_quiz` DISABLE KEYS*/;
REPLACE INTO `wquiz_person_quiz` (`id_person_quiz`, `id_quiz`, `id_person`, `points`, `totaltime`, `date`) VALUES
	(17,1,5,2,'00:00:04','2008-09-25 23:09:09'),
	(18,1,4,3,'00:00:20',NULL),
	(19,1,19,3,'00:00:04',NULL),
	(20,1,21,4,'00:00:04',NULL);
/*!40000 ALTER TABLE `wquiz_person_quiz` ENABLE KEYS*/;
UNLOCK TABLES;
